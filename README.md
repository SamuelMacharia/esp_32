...
-Event Groups are used to:
    -Signal when WiFi is connected (WIFI_CONNECTED_BIT | WIFI_FAILED_BIT)
    -Signal when a stream Client is ready (STREAM_READY_BIT)
-Queues store camera frames between capture task and streaming task to avoid race conditions and lost franes.
...
# Software Setup
1. Install ESP-IDF and setup your environment
2. Clone the repository
    git clonehttps://github.com/SamuelMacharia/esp_32.git
    cd esp32
